...
// //         }
// //     }
// //     plane.point = cylin.bottomCapCent;
// //     if (intersectPlane(ray, plane, &crossPlane))
// //     {
// //         if (distance(crossPlane.p, cylin.bottomCapCent) <= cylin.radius && crossPlane.t < t)
// //         {
// //             *cross = crossPlane;
// //             t = cross->t;
// //         }
...
// //     {
// //         if(pow(distance(cylin.center, cross->p), 2) <= pow(cylin.height * 0.5, 2) + cylin.radius * cylin.radius)
// //         {
// //             t = cross->t;
// //         }
// //         else
